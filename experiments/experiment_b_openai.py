...
def run_experiment():
    ...
    with open("experiment_b_openai_results.json", "w", encoding="utf-8") as f:
        json.dump(all_results, f, ensure_ascii=False, indent=2)
    print(f"\n  💾 Сохранено в experiment_b_openai_results.json")


if __name__ == "__main__":
    print("🔬 Эксперимент B — GPT-4o-mini (OpenAI)")
    print()
    if phase1():
        print("\n  Logprobs работают. Запускаю эксперимент B...")
        run_experiment()
    else:
        print("\n  Logprobs не доступны.")
