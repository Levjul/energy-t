...
1. Entropy-сигналы из спринта (445×, p=3.8e-13) были вычислены из **полных top-k logprobs** (k=20), а не из одного значения.
...
Честный negative result: NLL-only proxy insufficient. Подтверждает что entropy-сигналы — не тривиальное следствие logprob magnitude, а структурные свойства распределения, доступные только через top-k.

---

*B3 | Opus 4.6 | 03.08.2026*
